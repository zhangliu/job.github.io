      ...
      <div className="h:100% w:100% d:f jc:c ai:c">
        ...
        <Page>
          <div className="d:f ai:c jc:c h:100%">
            <img className="h:200 mr:20 bw:6 bs:s bc:222" src="./imgs/2.jpeg" alt="" />
            <img className="h:200 mr:20 bw:6 bs:s bc:aa0000" src="./imgs/3.jpeg" alt="" />
            <img className="h:200 bw:6 bs:s bc:00aa00" src="./imgs/4.jpeg" alt="" />
          </div>
        </Page>
        <Page>
        ...
        <Page>
          <div className="d:f fd:c jc:c h:100% fs:24">
